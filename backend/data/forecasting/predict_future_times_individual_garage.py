...
LONG_TRAINING_MASK: List[bool]      = [True,True,True,True]
SHORT_TRAINING_MASK: List[bool]     = [False,False,False,False] 

LONG_HYPER_PARAMS: Dict[str, Dict[str, Any]] = {
    "south":        {'lstm_neurons_list': [77, 73, 205, 216], 'lstm_layers': 4, 'dropout': 0.2500845427465502, 'learning_rate': 0.0018339163857906118, 'activation': 'hard_sigmoid', 'optimizer': 'adamax', 'batch_size': 512},
    "west":         {'lstm_neurons_list': [110, 183, 207, 508], 'lstm_layers': 4, 'dropout': 0.44826929785781433, 'learning_rate': 0.000483311322469442, 'activation': 'hard_tanh', 'optimizer': 'adam', 'batch_size': 256},
    "north":        {'lstm_neurons_list': [327, 179, 417, 317], 'lstm_layers': 4, 'dropout': 0.5745106585317661, 'learning_rate': 0.0009967926629038712, 'activation': 'hard_sigmoid', 'optimizer': 'adamw', 'batch_size': 256},
    "south_campus": {'lstm_neurons_list': [141, 258, 327, 245, 275], 'lstm_layers': 5, 'dropout': 0.15608111088723042, 'learning_rate': 0.0006491010489281348, 'activation': 'gelu', 'optimizer': 'rmsprop', 'batch_size': 256},
}
...
SHORT_HYPER_PARAMS: Dict[str, Dict[str, Any]] = {
    ...
    "north": {
        ...
        "activation": "leaky_relu",},
    "south_campus": {
        "lstm_neurons_list": [345],
        "dropout": 0.5038588456617183,
        "learning_rate": 0.002592606244810359,
        "activation": "leaky_relu",}
}
